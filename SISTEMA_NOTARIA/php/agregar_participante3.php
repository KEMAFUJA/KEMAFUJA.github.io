...
$nombre_beneficiario   = $_POST['nombre_beneficiarios'] ?? '';
...
$stmt = $pdo->prepare("INSERT INTO participante 
    ...
    INSERT INTO part_poder
    (id_documento, nombre_beneficiario) 
    VALUES (?, ?)
    RETURNING id_participante");
$stmt->execute([$id_documento, $nombre_beneficiarios]);
...
echo json_encode([
    ...
    'nombre_beneficiario' => $nombre_beneficiarios
]);
