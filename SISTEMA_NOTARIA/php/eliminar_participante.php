...
if(!isset($_POST['id_participante'])) die("No se indicó participante");
...
$stmt = $pdo->prepare("DELETE FROM participante WHERE id_participante = ?");
$stmt->execute([$_POST['id_participante']]);
