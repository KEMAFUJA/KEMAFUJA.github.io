async function filtrarActas() {
    const params = new URLSearchParams({
        ...
        tipo_poder: document.querySelector('[data-filtro="tipo_poder"]').value,
        testigos: document.querySelector('[data-filtro="testigos"]').value,
        cant_poderante: document.querySelector('[data-filtro="cant_poderante"]').value,
        cant_poderados: document.querySelector('[data-filtro="cant_poderados"]').value,
        ...
        nombre_beneficiarios: document.querySelector('[data-filtro="nombre_beneficiarios"]').value
    });
